...
def create_html_report_from_notebook(notebook_path: str, html_path: str, python_kernel: str, **parameters: Any) -> None:
    """
...
def main(args: Optional[Sequence[str]] = None) -> None:
    ...
    create_html_report_from_notebook(args.notebook, args.report_path, args.python_kernel, **kwargs)
