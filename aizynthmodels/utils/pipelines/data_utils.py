...
def extract_route_reactions(filenames: List[str], metadata_key="reaction_hash") -> Set[str]:
    """
...
def split_data(
    ...
    if len(val_arr) > 1:
        val_arr, train_arr = train_test_split(val_arr, test_size=0.5, random_state=random_seed, shuffle=True)
